...
# install v2ray
wget https://raw.githubusercontent.com/SSHSEDANG4/vpn/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O certv2ray "https://raw.githubusercontent.com/SSHSEDANG4/vpn/main/cert.sh"
chmod +x add-ws
chmod +x add-vless
chmod +x add-tr
chmod +x del-ws
